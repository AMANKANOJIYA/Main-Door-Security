...
submit.addEventListener("click", () => {
    ...
    if (usernamecheck == USERNAME && passwordcheck == PASSWORD) {
        ...
        close_modal.addEventListener("click", () => {
            ...
            body.style.background = "linear-gradient(45deg, rgb(247 15                      17), transparent, rgb(247 15 17))";
        ...
        open_modal.addEventListener("click", () => {
            ...
            body.style.display = "block";
            parent.style.display = "block";
            body.style.background = "linear-gradient(45deg, rgb(126 255                     23), transparent, rgb(126 255 23))";
        ...
        help_modal.addEventListener("click", () => {
            body.style.display = "block";
            parent.style.display = "block";
            body.style.background = "linear-gradient(45deg, #17d7ff,                        transparent,#17d7ff)";
            body.style.filter = "blur(10px)";
            para.style.display = "block"
            text.innerText = "HELP"
    ...
    // the  2 condition is executed as the password is wrong 
        ...
        if (count >= 4) {
            ...
            console.log("ErrorErrorErrorErrorErrorErrorErrorErrorErrorEr                      rorErrorErrorErrorErrorErrorErrorError")
        }
